...
typst c docs/docs.typ docs/docs.pdf --font-path test/antonio
...
magick -size 3010x2139 canvas:none \
  ...
  \( test/page-5.png  \( +clone -background black -shadow $SHADOW \) +swap -background none -layers merge +repage \) -geometry +1200+80   -compose over -composite \
